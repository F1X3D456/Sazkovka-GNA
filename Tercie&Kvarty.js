...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const pravdepodobnost1 = 0.35;  // O3.A VS O3.B 
    const pravdepodobnost2 = 0.175; // O3.A VS O4.A
    const pravdepodobnost3 = 0.15;  // O3.A VS O4.B
    const pravdepodobnost4 = 0.20;  // O3.B VS O4.A
    const pravdepodobnost5 = 0.175; // O3.B VS O4.B
